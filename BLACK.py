...
#AUTHOR : CHIGOZIEWORLDWIDE (BLACK)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO BLACK
...
header = {"user-agent": '[Mozilla/5.0 (BB10; Touch) AppleWebKit/537.10+ (KHTML, like Gecko) Version/10.0.9.2372 Mobile Safari/537.10+;]',
